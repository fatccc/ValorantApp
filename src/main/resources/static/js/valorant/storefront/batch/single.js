...
table.render({
    ...
    ,url: app.util.api.getAPIUrl('valorant.storefront.batchQuerySingle')
    ,method: 'GET'
...
table.on('toolbar(dataTable)', function(obj){
    switch(obj.event){
        case 'batchUpdateSingle' :
            batchUpdateSingle();
            break;
    };
});

function batchUpdateSingle() {
    app.util.ajax.post(app.util.api.getAPIUrl('valorant.storefront.batchUpdateSingle'),
        null,
        function (res) {
            // console.log(res);
